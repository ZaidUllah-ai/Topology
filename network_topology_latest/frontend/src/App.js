    ...
    <Context>
      <Router>
        ...
        <Routes>
          ...
          <Route path="/edn-topology-dashboard/central" element={<CentralFlagship />} />
          <Route path="/edn-topology-dashboard/eastern" element={<EasternFlagship />} />
          <Route path="/edn-topology-dashboard/western" element={<WesternFlagship />} />
        </Routes>
      </Router>
    </Context>
  );
